...
class deviantARTFilter {
    ...
    manage(event) {
        ...
        this.filters.forEach(function (filter) {
            ...
            //@TODO get count of filters and display above table - will need to be updated dynamically...

            //@TODO make getTable() async, show loading indicator until Promise is resolved
