    ...
    const Filters = {
        ...
        'importFilterData': async function (id, items) {
            ...
            try {
                ...
                // the Management screen open. It could do a search for the Management screen's URL, but that would
                // NOT work if/when the modal (on a native DeviantArt page) is used - this almost needs to go to
                // every open tab, WITHOUT any restriction (BrowserTabs.sendMessageToAllTabs is restricted to DA URLs)
        ...
        'toggleFilterItem': async function (id, item) {
            ...
            try {
                ...
                // this message is primarilly for the Management screen (IIRC...)
