...
browser.runtime.onMessage.addListener((message, sender, sendResponse) => {
    console.log('Content Script :: browser.runtime.onMessage', message, sender, sendResponse);
...
browser.storage.sync.get('placeholders').then((data) => {
    document.querySelector('body').classList.add(data.placeholders ? 'placeholders' : 'no-placeholders');
});
